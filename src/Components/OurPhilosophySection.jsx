...
import philosophyBg from "../images/philosopy.png";
...
const steps = [
    ...
    {
        id: 2,
        key: "Growth Through Value Creation ",
...
const OurPhilosophySection = () => {
    ...
    return (
        <section className="relative w-full py-40 px-6 md:px-32 overflow-hidden text-white">
