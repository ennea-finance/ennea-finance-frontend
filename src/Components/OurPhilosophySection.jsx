...
const OurPhilosophySection = () => {
    ...
    return (
        ...
        >
            {/* Heading */}
            <div className="mx-auto mb-16 w-full md:w-[70vw]">
                <h2 className="text-3xl lg:text-4xl md:text-5xl font-bold">
                    Our <span className="font-playfair">Philosophy</span>
                </h2>
            </div>

            {/* Slider */}
            <div
                className={`relative mx-auto overflow-hidden ${isMobile ? "w-full" : "w-[70vw]"
                    }`}
            >
                <motion.div
                ...
                >
                    {steps.map((step) => (
                        <div
                            key={step.id}
                            className="shrink-0"
                            style={{ width: isMobile ? "100%" : "56vw" }}
                        >
                            <div className="rounded-3xl lg:p-10 p-9 md:p-14 h-full flex flex-col gap-6 border border-white">
                                ...
                                <h3 className="font-satoshi font-bold lg:text-2xl text-xl md:text-3xl text-white">
                                    {step.label}
                                </h3>

                                <p className="text-white lg:text-lg text-md md:text-xl leading-relaxed">
                                    {step.title}
                                </p>
                            </div>
                        </div>
            ...
            {/* Controls */}
            <div className="mx-auto flex justify-start gap-4 mt-10 w-full md:w-[70vw]">
                <button
                    onClick={prev}
                    disabled={active === 0}
